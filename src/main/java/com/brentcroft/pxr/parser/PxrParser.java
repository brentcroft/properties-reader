...
/** Root production. */
  final public PxrProperties parse() throws ParseException {PxrProperties rp;
    rp = footer();
{if ("" != null) return rp;}
    throw new Error("Missing return statement in function");
}

  final public PxrProperties footer() throws ParseException {String space = null;
    String init = null;
    String text = null;
    boolean eol = false;
    String key = null;
...
{if ("" != null) return b.toString();}
  ...
  final public List<PxrEntryContinuation> continuations() throws ParseException {Token t = null;
    ...
    String space = null;
    String value = null;
    List<PxrEntryContinuation> cont = new ArrayList<>();
    int index = 1;
    label_3:
    while (true) {
